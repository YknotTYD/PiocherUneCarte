...
function ddddduel() {
  ...
  if (question == null) {
    ...
    answer_a = add_to_box("button", "answer", current_q_data.answer_a, "aa");
    answer_b = add_to_box("button", "answer", current_q_data.answer_b, "ab");
